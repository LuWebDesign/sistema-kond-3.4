...
const MetricasPedidosContent = dynamic(() => Promise.resolve(MetricasPedidosPage), {
  ssr: false,
  loading: () => (
    <Layout title="Métricas de Pedidos - Sistema KOND">
      <div className={styles.loading}>Cargando métricas...</div>
    </Layout>
  )
})

function MetricasPedidosPage() {
...
function MetricasPedidos() {
  return <MetricasPedidosContent />
}

export default withAdminAuth(MetricasPedidos)
