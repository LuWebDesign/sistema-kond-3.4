-- ============================================
-- SISTEMA KOND - MIGRACIN DE USUARIOS A UUID
-- Opcin A: Cambiar id de usuarios de SERIAL a UUID
-- ============================================

-- IMPORTANTE: Ejecutar ANTES de las polticas RLS
...
-- 2. Eliminar tabla usuarios (si est vaca, no hay problema)
